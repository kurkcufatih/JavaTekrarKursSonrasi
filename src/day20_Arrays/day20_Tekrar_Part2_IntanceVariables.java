...
import day20_scope.InstanceVar;

public class day20_Tekrar_Part2_IntanceVariables {
    ...
    public static void main(String[] args) {
        ...
        day20_Tekrar_Part2_IntanceVariables celil = new day20_Tekrar_Part2_IntanceVariables();

        System.out.println(celil.notMat); // 50

        day20_Tekrar_Part2_IntanceVariables nihal = new day20_Tekrar_Part2_IntanceVariables();
