...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar); //[I@7699a589
        /*
        Non-primitive data turundeki datalari her zaman
        direk yazdiramayabiliriz.
        Array'i yazdirmak istersek Javadaki Arrays class'indan yardim isteriz.
         */
