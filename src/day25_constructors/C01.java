...
public class C01 {
   ...
   olusturulan her bir class'in ihtiyac
   oldugunda obje uretebilmesine uygun dizayn
   etmistir.
   Ama her class'dan obje uretebilmeyebilir.
   ...
   C02 class'inda icinde oldugumuz C01 class'indan
